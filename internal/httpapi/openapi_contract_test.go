...
var routerTruth = map[string][]string{
	...
	"/api/workspaces/{workspaceId}/audit":                                              {"get"},
	...
	"/api/workspaces/{workspaceId}/note-containers":                                    {"get", "post"},
	"/api/workspaces/{workspaceId}/note-containers/{containerId}":                      {"patch", "delete"},
	"/api/workspaces/{workspaceId}/doc-containers":                                     {"get", "post"},
	"/api/workspaces/{workspaceId}/doc-containers/{containerId}":                       {"patch", "delete"},
	"/api/workspaces/{workspaceId}/doc-containers/{containerId}/category-publication":  {"get", "put"},
	"/api/conversations/{conversationId}/note-container":                               {"put"},
	...
	"/api/workspaces/{workspaceId}/sites/{siteId}/bindings":                            {"get"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/inclusions/{assetId}/exclusion":      {"put", "delete"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/inclusions/{assetId}/feature":        {"put", "delete"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/preview":                             {"get", "post"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/design-sessions":                     {"post"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/design-sessions/{sessionId}":         {"get", "patch", "delete"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/design-sessions/{sessionId}/apply":   {"post"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/design-sessions/{sessionId}/preview":  {"get"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/design-sessions/{sessionId}/preview-link": {"post"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/theme/draft":                          {"get", "put"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/theme/revisions":                      {"get"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/theme/revisions/{revisionId}/publish": {"post"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/pages":                                {"get", "post"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/pages/{pageId}":                       {"patch", "delete"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/summary":                             {"get"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/lint":                                {"get"},
	"/api/workspaces/{workspaceId}/sites/{siteId}/activity":                            {"get"},
	"/api/workspaces/{workspaceId}/modeling-plans":                                     {"get", "post"},
	"/api/workspaces/{workspaceId}/modeling-plans/{planId}":                            {"get", "patch"},
	...
	"/api/admin/agent-users":                                                           {"get", "post"},
	"/api/public/sites/{slug}/chat":                                                    {"post"},
	"/api/public/sites/{slug}/chat/quota":                                              {"get"},
	...
	"/api/resource-models/{resourceModelId}/public-view":                               {"get", "put"},
