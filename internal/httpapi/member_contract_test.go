...
func TestMemberContractRoutesRequireSession(t *testing.T) {
	cases := []struct {
		...
		{"asset relations", http.MethodGet, "/api/assets/00000000-0000-4000-8000-000000000001/relations"},
		{"attachment upload", http.MethodPost, "/api/workspaces/00000000-0000-4000-8000-000000000001/attachments"},
