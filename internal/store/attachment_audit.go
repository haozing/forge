...
// The metadata carries the owning workspace_id so the record stays visible in
// per-workspace audit views (they filter on metadata->>'workspace_id').
